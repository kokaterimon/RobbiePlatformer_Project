...
namespace UnityEditor
{
    ...
    public class GroupBrush : Tilemaps.GridBrush
    {
        ...
        private void UpdateSizeAndPivot(Vector3Int size, Vector3Int vector3Int)
        {
            throw new NotImplementedException();
        }
        ...
        private void SetColor(Vector3Int brushPosition, Color color)
        {
            throw new NotImplementedException();
        }

        private void SetMatrix(Vector3Int brushPosition, Matrix4x4 matrix4x4)
        {
            throw new NotImplementedException();
        }

        private void SetTile(Vector3Int brushPosition, TileBase tileBase)
        {
            throw new NotImplementedException();
        }
